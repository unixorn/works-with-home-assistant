...
| [FIBARO Smart Implant FGBS-222](https://www.amazon.com/dp/B07NDRCTJK/ref=cm_sw_em_r_mt_dp_V0TBF8HYF19P65N9AFVB?_encoding=UTF8&psc=1) | Plugin Universal DIY Tool | Allows for connecting: 6 DS18B20 sensors or 1 DHT sensor and  2 2-wire analog sensors, 2 3-wire analog sensor, 2 binary sensors **NOTE: The internal Temp Sensor is too close to other components to be accurately used without compensating. Also requires not included power supply. 
