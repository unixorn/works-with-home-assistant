...
| -------------- | ----------- | ---------------- | ------------------------------------- |
| Dimmer Switch | Tuya | [Rotary Dimmer (Model TS004F)](https://www.aliexpress.us/item/3256802832125833.html) | Rotary dimmer button, recognized by ZHA. "Works" but kinda annoying b/c dimming up/down is a frustrating experience |
