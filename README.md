...
| [Home Assistant Postgresql Backup](https://github.com/unixorn/hass-postgresql-backup)| A simple tool for backing up your Home Assistant database if you're using Ppostgresql. |
